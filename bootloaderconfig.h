 ...
 */
#define USB_CFG_DMINUS_BIT      3 // Changed KM
...
{
    PORTD |= (1 << USB_CFG_DMINUS_BIT);     /* activate pull-up */ // changed to use D- pin for USnooBie
...
#define bootLoaderCondition()   ((PIND & (1 << USB_CFG_DMINUS_BIT)) == 0) // changed to use D- pin for USnooBie
